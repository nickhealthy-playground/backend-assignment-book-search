...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleApiException(ApiException e) {
        log.error("Api Exception occurred. message={}, className={}", e.getMessage(), e.getClass().getName());
    ...
    public ResponseEntity<ErrorResponse> handleApiException(NoResourceFoundException e) {
    ...
    public ResponseEntity<ErrorResponse> handleApiException(MethodArgumentTypeMismatchException e) {
    ...
    public ResponseEntity<ErrorResponse> handleApiException(MissingServletRequestParameterException e) {
    ...
    public ResponseEntity<ErrorResponse> handleApiException(BindException e) {
